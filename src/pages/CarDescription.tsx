    ...
    <div className="px-20">
      <div>
        <header className="mt-2 mb-[6.25rem]">
          ...
          <div className="my-5">
            <h2 className="text-4xl font-semibold mb-2">{propsData.name}</h2>
          ...
          <div className="col-span-2 w-[90%]">
            ...
            <div className="bg-slate-50 py-5 px-8 my-[6.25rem]">
              ...
              <div>
                ...
                <div className="[&>*]:mb-3 [&>*]:grid [&>*]:grid-cols-3 [&>*>p]:text-slate-500 [&>*>h2]:text-slate-500 [&>*>h2]:font-semibold">
                  ...
                  <div>
                    <p>Mileage: </p> <h2>{propsData.mileage}</h2>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-50 py-5 px-8 mb-[6.25rem]">
              ...
              <p className="text-xs w-[30%] leading-6">
                ...
                Delectus at dolore nihil, reprehenderit quod minus dolores
                ducimus iusto aperiam ipsum, est quae autem deserunt eum quis
                odio, blanditiis neque quibusdam.
              </p>
            </div>
          </div>
                  ...
                  {isMakingOffer && (
                    <>
                      ...
                      <section className="flex gap-4">
                        <button
                          className="btn bg-[#CFD3DC] text-gray-secondary"
                        ...
                        <button
                          type="submit"
                          className="btn bg-blue-primary text-white"
                        >
                          Send
                        </button>
                      </section>
